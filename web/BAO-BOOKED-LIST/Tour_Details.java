...
public class Tour_Details {
    ...
    public Tour_Details(String name, double totalPrice, String thumbnail, int trip_id, int tour_id, int quantityAdult, int quantityChild, boolean status, Date departtime) {
        this.name = name;
