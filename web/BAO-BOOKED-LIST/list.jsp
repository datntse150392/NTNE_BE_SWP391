...
<html>
    <head>
        ...
        <link href="<c:url value="/CSSMAIN/Profile_User/tourlist.css" />" rel="stylesheet" type="text/css"/>  
    ...
    <script src="/CSSMAIN/Profile_User/TestJS.js" type="text/javascript"></script>
    <script>
