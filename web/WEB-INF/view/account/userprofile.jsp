...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../assets/css/UserProfile/styleindex.css">
                ...
                <div class="header__container">
                    ...
                    <div class="header__nav">
                        <ul class="header__nav-list">
                            <li class="header__nav-item"><a href="" class="header__nav-link">Trang chủ</a></li>
                        ...
                        <div class="wrapper-left">
                            <div class="info">
                                <div class="info-image">
                                    <a href="#">
                                        <img alt="Avatar user" src="${sessionScope.person.linkImg}" />
                                    </a>
                                </div>
                                    ...
                                    <li class="profile-link-collapse">
                                        ...
                                        <div class="collapse-show">
                                            <ul class="profile-acct-opt">
                                                <li><a href="<c:url value="/account/displayUserProfile.do"/>">Thông tin cá nhân</a></li>
                                                <li><a href="<c:url value="/account/changePassword.do"/>">Đổi mật khẩu</a></li>
                                                <li><a href="<c:url value="/account/logOut.do"/>">Đăng xuất</a></li>
                                            </ul>
                                        </div>
                                    </li>
