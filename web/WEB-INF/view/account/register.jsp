                        ...
                        <div class="login-body">
                            ...
                            <div class="login-form">
                                <div class="login-form-header">
                                    <form action="registerHandler.do" method="post">
                                        <div class="login-form-user fill-form">
                                            <label for="username">
                                                Họ và tên<span style="color: red; font-size:small;">(*)</span>
                                                <br>
                                                <input id="fullname" type="text" required name="fullname" placeholder="Nguyen Van A">
                                            </label>
                                        </div>
                                        <div class="login-form-password fill-form">
                                            <label for="email">
                                                Email<span style="color: red; font-size:small;">(*)</span>
                                                <br>
                                        ...
                                        <div class="login-form-password fill-form">
                                            <label for="password">
                                                Mật khẩu<span style="color: red; font-size:small;">(*)</span>
                                                <br>
                                                <div class="icon-container">
                                                    ...
                                                    <input type="password" id="password" minlength="1" required name="password" placeholder="Mật khẩu"
                                                           class="changetype">
                                                </div>
                                            </label>
                                        </div>
                                        <div class="login-form-password fill-form">
                                            <label for="repassword">
                                                Nhập lại mật khẩu<span style="color: red; font-size:small;">(*)</span>
                                                <br>
                                                <div class="icon-container">
                                                    <a href="#">
                                                        <i class="fa-solid fa-eye"></i>
                                                    ...
                                                    <input type="password" id="re_password" minlength="1" required name="re_password" placeholder="Nhập lại mật khẩu"
                                                           class="changetype">
                                                </div>
                                            </label>
                                        </div>
                                        ...
                                        <div class="login-form-password fill-form">
                                            <label for="phone">
                                                Số điện thoại<span style="color: red; font-size: small;">(*)</span>
                                                <br>
                                                <input type="text" id="phone" required name="phone" minlength="10" maxlength="10" placeholder="0xx.xxx.xxxx">
                                            </label>
                                        </div>
                                        <p style="color: red; text-align: left">${MSG_ERROR}</p>
                                        <button class="press-login" type="submit">Đăng kí</button>
                                    </form>
                                </div>
                            </div>
                        </div>
