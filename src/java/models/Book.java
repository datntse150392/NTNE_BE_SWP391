...
public class Book {
    ...
    public Book(int bookID, double totalPrice, String requirement, String cusBook, String cusMail, String cusPhone, String expireDate, boolean status, int payment_id, int quantityAdult, int quantityChild, int trip_id, String cusAddress, String reason) {
        this.bookID = bookID;
        this.totalPrice = totalPrice;
        this.requirement = requirement;
        this.cusBook = cusBook;
