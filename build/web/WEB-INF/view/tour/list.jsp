...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="./assets/css/TourListCSS/style.css">
        <link rel="stylesheet" href="./assets/css/TourListCSS/plugins.css">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="./homepage_new.html">Trang chủ</a>
                        </li>
                                        ...
                                        <div class="col-md-5 col-sm-5">
                                            <div class="tour-box-image">
                                                <a href="tour-detail.html">
                                                    <img src="https://firebasestorage.googleapis.com/v0/b/nha-trang-nature-elite.appspot.com/o/Images%20For%20Logo%20-%20Sliders%20-%20Other%2FTrang%20ch%E1%BB%A7%2FTour%20list%2Ftour1.jpg?alt=media&token=0d2561fd-d2fb-4b37-9ea7-77aa2fec3ea6&_gl=1*drs4rk*_ga*MTEyNjY4OTYyMi4xNjgzNzM0MDMx*_ga_CW55HF8NVT*MTY4NjM3NzM4OC4xNC4xLjE2ODYzNzc0MjguMC4wLjA." class="img-responsive tour-box-img" alt="">
                                                </a>
                                                ...
                                                <div class="box-inner-ellipsis">
                                                    <div style="margin: 0px; padding: 0px; border: 0px;">
                                                        <h3 class="entry-title">
                                                            <a href="tour-detail.html">Vinpearl Land</a>
                                                        </h3>
                                                        <div class="entry-content">
                                                            <p>Thiên đường giải trí. Khu vui chơi đẳng cấp hàng đầu tại Việt Nam.</p>
                                                            <span class="price"><strong class="theme-cl">800,000 VND</strong> /người lớn</span>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <article class="tour-box list-style">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 col-sm-5">
                                            <div class="tour-box-image">
                                                <a href="tour-detail.html">
                                                    <img src="https://firebasestorage.googleapis.com/v0/b/nha-trang-nature-elite.appspot.com/o/Images%20For%20Logo%20-%20Sliders%20-%20Other%2FTrang%20ch%E1%BB%A7%2FTour%20list%2Ftour2.jpg?alt=media&token=a43242ce-3144-4d90-a132-4e814aed891a&_gl=1*c6rt68*_ga*MTEyNjY4OTYyMi4xNjgzNzM0MDMx*_ga_CW55HF8NVT*MTY4NjM3NzM4OC4xNC4xLjE2ODYzNzc0NjcuMC4wLjA." class="img-responsive tour-box-img" alt="">
                                                </a>
                                                <div class="entry-bookmark">                                   
                                                    <a href="#"><i class="ti-bookmark"></i></a>
                                                </div>
                                        ...
                                        <div class="col-md-7 col-sm-7">	
                                            <div class="inner-box">
                                                ...
                                                <div class="box-inner-ellipsis">
                                                    <div style="margin: 0px; padding: 0px; border: 0px;">
                                                        <h3 class="entry-title">
                                                            <a href="tour-detail.html">Tour 4 Đảo Nha Trang</a>
                                                        </h3>
                                                        <div class="entry-content">
                                                            <p>Tứ Đảo Nha Trang. Viên ngọc trai của biển cả.</p>
                                                            <span class="price"><strong class="theme-cl">500,000 VND</strong> /người lớn</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="entry-meta">
                                                    <div class="meta-item meta-author">
                                                        <div class="coauthors">
                                                            <span class="vcard author">
                                                                <span class="fn">
                                                                    <a href="#"><img alt="" src="assets/img/user-2.jpg" class="avatar avatar-24" height="24" width="24">Long Bùi</a>
                                                                </span>
                                                            </span>
                                                        </div>
                                                    </div>
                                ...
                                <article class="tour-box list-style">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 col-sm-5">
                                            <div class="tour-box-image">
                                                <a href="tour-detail.html">
                                                    <img src="https://firebasestorage.googleapis.com/v0/b/nha-trang-nature-elite.appspot.com/o/Images%20For%20Logo%20-%20Sliders%20-%20Other%2FTrang%20ch%E1%BB%A7%2FTour%20list%2Ftour3.jpg?alt=media&token=9a180760-f281-4a5c-9b6d-b28914ed00d4&_gl=1*l4z69w*_ga*MTEyNjY4OTYyMi4xNjgzNzM0MDMx*_ga_CW55HF8NVT*MTY4NjM3NzM4OC4xNC4xLjE2ODYzNzc1NTQuMC4wLjA." class="img-responsive tour-box-img" alt="">
                                                </a>
                                                <div class="entry-bookmark">                                   
                                                    <a href="#"><i class="ti-bookmark"></i></a>
                                                </div>
                                        ...
                                        <div class="col-md-7 col-sm-7">	
                                            <div class="inner-box">
                                                ...
                                                <div class="box-inner-ellipsis">
                                                    <div style="margin: 0px; padding: 0px; border: 0px;">
                                                        <h3 class="entry-title">
                                                            <a href="tour-detail.html">Tour Vịnh Đảo Bình Ba</a>
                                                        </h3>
                                                        <div class="entry-content">
                                                            <p>Nét đẹp hoang sơ nhưng yên bình nơi biển đảo. Vương quốc tôm hùm.</p>
                                                            <span class="price"><strong class="theme-cl">700,000 VND</strong> /người lớn</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="entry-meta">
                                                    <div class="meta-item meta-author">
                                                        <div class="coauthors">
                                                            <span class="vcard author">
                                                                <span class="fn">
                                                                    <a href="#"><img alt="" src="assets/img/user-3.jpg" class="avatar avatar-24" height="24" width="24">Long Bùi</a>
                                                                </span>
                                                            </span>
                                                        </div>
                                                    </div>
                                ...
                                <article class="tour-box list-style">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 col-sm-5">
                                            <div class="tour-box-image">
                                                <a href="tour-detail.html">
                                                    <img src="https://firebasestorage.googleapis.com/v0/b/nha-trang-nature-elite.appspot.com/o/Images%20For%20Logo%20-%20Sliders%20-%20Other%2FTrang%20ch%E1%BB%A7%2FTour%20list%2Ftour4.jpg?alt=media&token=6af3feae-67ae-43bf-a1fa-39530c95644f&_gl=1*1ab0ava*_ga*MTEyNjY4OTYyMi4xNjgzNzM0MDMx*_ga_CW55HF8NVT*MTY4NjM3NzM4OC4xNC4xLjE2ODYzNzc2NzQuMC4wLjA." class="img-responsive tour-box-img" alt="">
                                                </a>
                                                <div class="entry-bookmark">                                   
                                                    <a href="#"><i class="ti-bookmark"></i></a>
                                                </div>
                                        ...
                                        <div class="col-md-7 col-sm-7">	
                                            <div class="inner-box">
                                                ...
                                                <div class="box-inner-ellipsis">
                                                    <div style="margin: 0px; padding: 0px; border: 0px;">
                                                        <h3 class="entry-title">
                                                            <a href="tour-detail.html">Tour Đảo Bình Hưng</a>
                                                        </h3>
                                                        <div class="entry-content">
                                                            <p>Hòn ngọc thô của biển cả, thuần khiết và tự nhiên.</p>
                                                            <span class="price"><strong class="theme-cl">750,000 VND</strong> /người lớn</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="entry-meta">
                                                    <div class="meta-item meta-author">
                                                        <div class="coauthors">
                                                            <span class="vcard author">
                                                                <span class="fn">
                                                                    <a href="#"><img alt="" src="assets/img/user-4.jpg" class="avatar avatar-24" height="24" width="24">Long Bùi</a>
                                                                </span>
                                                            </span>
                                                        </div>
                                                    </div>
                                ...
                                <article class="tour-box list-style">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 col-sm-5">
                                            <div class="tour-box-image">
                                                <a href="tour-detail.html">
                                                    <img src="https://firebasestorage.googleapis.com/v0/b/nha-trang-nature-elite.appspot.com/o/Images%20For%20Logo%20-%20Sliders%20-%20Other%2FTrang%20ch%E1%BB%A7%2FTour%20list%2Ftour5.jpg?alt=media&token=36f0bd0d-5c11-46f1-8139-4b175a676272&_gl=1*1q89xoi*_ga*MTEyNjY4OTYyMi4xNjgzNzM0MDMx*_ga_CW55HF8NVT*MTY4NjM3NzM4OC4xNC4xLjE2ODYzNzc2OTUuMC4wLjA." class="img-responsive tour-box-img" alt="">
                                                </a>
                                                <div class="entry-bookmark">                                   
                                                    <a href="#"><i class="ti-bookmark"></i></a>
                                                </div>
                                        ...
                                        <div class="col-md-7 col-sm-7">	
                                            <div class="inner-box">
                                                ...
                                                <div class="box-inner-ellipsis">
                                                    <div style="margin: 0px; padding: 0px; border: 0px;">
                                                        <h3 class="entry-title">
                                                            <a href="tour-detail.html">Tour Du Thuyền 5 Sao Sea Coral</a>
                                                        </h3>
                                                        <div class="entry-content">
                                                            <p>Thế giới thượng lưu. Không gian xa hoa bậc nhất Nha Trang.</p>
                                                            <span class="price"><strong class="theme-cl">999,000 VND</strong> /người lớn</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="entry-meta">
                                                    <div class="meta-item meta-author">
                                                        <div class="coauthors">
                                                            <span class="vcard author">
                                                                <span class="fn">
                                                                    <a href="#"><img alt="" src="assets/img/user-5.jpg" class="avatar avatar-24" height="24" width="24">Long Bùi</a>
                                                                </span>
                                                            </span>
                                                        </div>
                                                    </div>
                                ...
                                <article class="tour-box list-style">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 col-sm-5">
                                            <div class="tour-box-image">
                                                <a href="tour-detail.html">
                                                    <img src="https://firebasestorage.googleapis.com/v0/b/nha-trang-nature-elite.appspot.com/o/Images%20For%20Logo%20-%20Sliders%20-%20Other%2FTrang%20ch%E1%BB%A7%2FTour%20list%2Ftour6.jpg?alt=media&token=315c71e2-b31d-4de6-a9f1-635ff0d032e8&_gl=1*1g86zy0*_ga*MTEyNjY4OTYyMi4xNjgzNzM0MDMx*_ga_CW55HF8NVT*MTY4NjM3NzM4OC4xNC4xLjE2ODYzNzc3MTQuMC4wLjA." class="img-responsive tour-box-img" alt="">
                                                </a>
                                                <div class="entry-bookmark">                                   
                                                    <a href="#"><i class="ti-bookmark"></i></a>
                                                </div>
                                        ...
                                        <div class="col-md-7 col-sm-7">	
                                            <div class="inner-box">
                                                ...
                                                <div class="box-inner-ellipsis">
                                                    <div style="margin: 0px; padding: 0px; border: 0px;">
                                                        <h3 class="entry-title">
                                                            <a href="tour-detail.html">Tour 3 Đảo Nha Trang</a>
                                                        </h3>
                                                        <div class="entry-content">
                                                            <p>Một ngày du hành Nha Trang với tam đảo độc nhất.</p>
                                                            <span class="price"><strong class="theme-cl">600,000 VND</strong> /người lớn</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="entry-meta">
                                                    <div class="meta-item meta-author">
                                                        <div class="coauthors">
                                                            <span class="vcard author">
                                                                <span class="fn">
                                                                    <a href="#"><img alt="" src="assets/img/user-6.jpg" class="avatar avatar-24" height="24" width="24">Long Bùi</a>
                                                                </span>
                                                            </span>
                                                        </div>
                                                    </div>
